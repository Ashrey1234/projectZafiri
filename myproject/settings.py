...
SECRET_KEY = 'django-insecure-_ls@o=2s-8l2=m4ld9q)hx%cj=put1s_lo9r+5g2fu6wf6a@e%'
...
CORS_ALLOW_ALL_ORIGINS = True  # kwa testing pekee
...
DATABASES = {
    'default': {
        ...
        'NAME': 'Research_db',        # Your database name
        'USER': 'postgres',        # Your database user
        'PASSWORD': '3838asks',# Your database password
